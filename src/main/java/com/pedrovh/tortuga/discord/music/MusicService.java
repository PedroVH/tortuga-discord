...
public class MusicService {
    ...
    public void handle(final DiscordApi api, final Message message) {
        try{
            ...
            loadAndPlay(api, message, author.getConnectedVoiceChannel(server).orElseThrow());
    ...
    private void loadAndPlay(final DiscordApi api, final Message message, final ServerVoiceChannel channel) {
